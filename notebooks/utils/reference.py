...
class BasicLayer(nn.Module):
    ...
    Args:
        ...
        fused_window_process (bool, optional): If True, use one kernel to fused window shift & window
        partition for acceleration, similar for the reversed part. Default: False
    """
...
class SwinTransformerReference2D(nn.Module):
    r"""Swin Transformer
